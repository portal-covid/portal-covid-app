...
function Simulador(props) {
    ...
    useEffect(() => {
        ...
        setCalculo(Calculo.calcularCapacidade(dados));
        setSimulacao(true);
    }, []);
		...
		<React.Fragment>
			<Grid container className={classes.root} spacing={1}>
                ...
                <Alert severity="info">
                    ...
                    <p>Para simular a capacidade de atendimento da sua unidade, basta preencher/alterar os dados dos quadros em destaque e clicar em SIMULAR</p>
                </Alert>
                </Grid>
             <Grid item xs={12} md={3} >
                    ...
                    <Grid item xs={12}>
                        ...
                        <br/>
                        <Button  style={{width:'100%'}} fullwidth={true} variant="contained" color="primary" onClick={simular}>
                            Simular
                        </Button>
					</Grid>
...
export default connect(mapStateToProps,mapDispacthToProps)(Simulador);
