...
function Epi(props) {
    ...
    useEffect(() => {
     ...
     const formData = {
         ...
         epcs_termometro: data['epc']['termometro'],
         epcs_lixeiras_pedal: data['epc']['lixeiras_pedal'],
    ...
    return (
        <React.Fragment>
            ...
            <Alert severity="info">
                ...
                <p>Prezado Gestor, esta aba é destinada a demonstrar o <strong>recebimento</strong> e a compilação dos dados referentes aos EPIs e EPCs da sua unidade.
                            ...
                            <Grid container className={classes.root}>
                                ...
                                <Grid item xs={12} md={5}>
                                    <Card className={classes.root} variant="outlined">
                                        <CardContent>
                                            <FormControl component="fieldset">
                                                <FormLabel component="legend">Termômetro</FormLabel>
                                                <RadioGroup  row aria-label="Termômetro"
                                                             name="epcs_termometro"
                                                             value={form.epcs_termometro}
                                                             onChange={handleInputChange}>
                                                    <FormControlLabel value="sim" inputprops={{ 'aria-label': 'SIM' }} control={<Radio />} label="Sim" />
                                                    <FormControlLabel value="nao" inputprops={{ 'aria-label': 'Não' }}  control={<Radio />} label="Não" />
                                                    <FormControlLabel value="nao se aplica" inputprops={{ 'aria-label': 'Não se aplica' }} control={<Radio />} label="Não se aplica" />
                                ...
                                <Grid item xs={12} md={5}>
                                    <Card className={classes.root} variant="outlined">
                                        <CardContent>
                                            <FormControl component="fieldset">
                                                <FormLabel component="legend">Lixeiras(descarte resíduos infectantes)</FormLabel>
                                                <RadioGroup  row aria-label="Lixeiras(descarte resíduos infectantes)"
                                                             name="epcs_lixeiras_pedal"
                                                             value={form.epcs_lixeiras_pedal}
                                                             onChange={handleInputChange}>
                                                    <FormControlLabel value="sim" inputprops={{ 'aria-label': 'SIM' }} control={<Radio />} label="Sim" />
                                                    <FormControlLabel value="nao" inputprops={{ 'aria-label': 'Não' }}  control={<Radio />} label="Não" />
                                                    <FormControlLabel value="nao se aplica" inputprops={{ 'aria-label': 'Não se aplica' }} control={<Radio />} label="Não se aplica" />
...
export default connect(mapStateToProps,mapDispacthToProps)(Epi);
