...
function Copyright() {
    return (
        <Typography variant="body2" color="textSecondary" align="center">
            ...
            <Link color="inherit" href="https://www-portalcovidinss.prevnet/">
                www-portalcovidinss.prevnet
            </Link>{' '}
    ...
    async function handleLogin(event) {
        ...
        try {
            await api.post('auth', data).then(response => {
                ...
                localStorage.setItem('isGexSr', response.data.dados.isGexSr);
                localStorage.setItem('isPodeDecidir', response.data.dados.isPodeDecidir);
                localStorage.setItem('siape', response.data.dados.siape);
