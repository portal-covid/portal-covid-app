...
export default function PainelDadosCapacidade(props) {
    ...
    for (let unidade in props) {
        ...
        dados.soma_metragem_administrativo += parseFloat(objeto.metragem_administrativo);
        dados.soma_metragem_perito += parseFloat(objeto.metragem_pericia_medica);
        dados.soma_guiches += parseInt(objeto.qtd_guiches);
        dados.soma_salas_assistente += parseInt(objeto.qtd_salas_ass);
        dados.soma_salas_peritos += parseInt(objeto.salas_pericia);
        dados.soma_scanners+= parseInt(objeto.qtd_scanner);
    }
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={2}>
                        <Paper  style={{backgroundColor:"#48CBEB"}} className={classes.paper} variant="outlined"  elevation={9}>
                            ...
                            <Typography className={classes.typography} variant="h5">
                                {dados.soma_metragem_administrativo.toFixed(2)} m²
                            </Typography>
                            <Typography className={classes.typography} variant="h6">
                                Área Administrativo
                            </Typography>
                    ...
                    <Grid item xs={12} md={2}>
                        <Paper style={{backgroundColor:"#48CBEB"}} className={classes.paper} variant="outlined"  elevation={9}>
                            ...
                            <Typography className={classes.typography} variant="h5">
                                {dados.soma_metragem_perito.toFixed(2)} m²
                            </Typography>
                            <Typography className={classes.typography} variant="h6">
                                Área Perícia Médica
                            </Typography>
